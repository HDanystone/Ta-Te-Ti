...
export function chequeaEstadoJuego(tablero, jugadorActual) {
  ...
  if (COMBINACIONES_GANADORAS.some((combinacion) =>
    combinacion.every((celda) =>
      tablero[celda] === jugadorActual))) return ESTADO.ganador
...
export function declaraResultado(estado) {
